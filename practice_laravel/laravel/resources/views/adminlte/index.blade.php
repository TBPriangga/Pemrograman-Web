      ...
      <section class="sidebar">
        ...
        <div class="user-panel">
          <div class="pull-left image">
            <img src="{{ url('') }}/laravel/vendor/almasaeed2010/adminlte/dist/img/user2-160x160.jpg" class="img-circle"
              alt="User Image">
          </div>
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="student/create"><i class="fa fa-circle-o"></i> Tambah Mahasiswa</a></li>
